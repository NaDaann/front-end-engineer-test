...
export function OnboardingHeader({ currentStep, totalSteps, onClose }: OnboardingHeaderProps) {
    const getStepIcon = () => {
        switch (currentStep) {
            ...
            case 3:
                return <ArrowUpDown className="w-5 h-5 text-green-400" />;
            case 4:
        ...
        <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center text-white text-lg font-bold bg-gradient-to-r from-green-800 to-green-900">
                        {currentStep + 1}
                    </div>
                    <div>
